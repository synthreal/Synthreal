//! SynthHub marketplace client — install skills from the registry.
//!
...
/// SynthHub registry configuration.
#[derive(Debug, Clone)]
...
impl Default for MarketplaceConfig {
    fn default() -> Self {
        Self {
            ...
            github_org: "synthreal-skills".to_string(),
        }
    }
}

/// Client for the SynthHub marketplace.
    ...
    pub fn new(config: MarketplaceConfig) -> Self {
        Self {
            ...
            http: reqwest::Client::builder()
                .user_agent("synthreal-skills/0.1")
                .build()
...
mod tests {
    ...
    fn test_default_config() {
        ...
        assert_eq!(config.github_org, "synthreal-skills");
    }

    #[test]
    fn test_client_creation() {
        let client = MarketplaceClient::new(MarketplaceConfig::default());
        assert_eq!(client.config.github_org, "synthreal-skills");
    }
}
