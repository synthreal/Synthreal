...
//! - Remote skills from SynthHub registry
...
pub enum SkillSource {
    /// Built into Synthreal or manually installed.
    Native,
    /// Bundled at compile time (ships with Synthreal binary).
    Bundled,
