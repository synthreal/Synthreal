...
use base64::Engine;
use synthreal_types::media::{GeneratedImage, ImageGenRequest, ImageGenResult};
use tracing::warn;
...
pub async fn generate_image(
    ...
    if request.model == synthreal_types::media::ImageGenModel::DallE3 {
...
mod tests {
    use super::*;
    use synthreal_types::media::ImageGenModel;
