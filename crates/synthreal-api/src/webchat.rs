...
#[allow(dead_code)]
const ETAG: &str = concat!("\"synthreal-", env!("CARGO_PKG_VERSION"), "\"");
...
/// GET /logo.png — Serve the Synthreal logo.
...
/// GET /favicon.ico — Serve the Synthreal favicon.
...
/// GET / — Serve the Synthreal Dashboard single-page application.
///
...
/// The embedded HTML/CSS/JS for the Synthreal Dashboard.
///
