...
//!
//! This is the Synthreal port of the Hermes Agent multi-destination cron
//! pattern: one job → N destinations (channels / webhooks / files / email).

use futures::future::join_all;
use synthreal_channels::bridge::ChannelBridgeHandle;
use synthreal_types::scheduler::CronDeliveryTarget;
