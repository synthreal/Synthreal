//! Shared error types for the Synthreal system.

use thiserror::Error;

/// Top-level error type for the Synthreal system.
#[derive(Error, Debug)]
pub enum SynthrealError {
...
/// Alias for Result with SynthrealError.
pub type SynthrealResult<T> = Result<T, SynthrealError>;
