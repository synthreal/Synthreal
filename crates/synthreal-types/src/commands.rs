...
//! chat (WebSocket).
//!
//! Each dispatch site (there are three: `synthreal-cli/src/tui/mod.rs`,
//! `synthreal-channels/src/bridge.rs`, `synthreal-api/src/ws.rs`) retains its own
...
/// Every slash command registered in Synthreal.
///
/// Keep this list in sync with the three dispatch sites:
///   - `synthreal-cli/src/tui/mod.rs::handle_slash_command`
///   - `synthreal-channels/src/bridge.rs::handle_command`
///   - `synthreal-api/src/ws.rs::handle_command`
