//! Discord Gateway adapter for the Synthreal channel bridge.
//!
...
async fn parse_discord_message(
    ...
    // Enable with: RUST_LOG=synthreal_channels::discord=debug
    debug!(target: "synthreal_channels::discord", payload = %d, "discord raw message payload");
...
mod tests {
    ...
    async fn test_parse_discord_mention_detection() {
        ...
        let d = serde_json::json!({
            ...
            "mentions": [{"id": "bot123", "username": "synthreal"}],
            "author": {
                "id": "user1",
                "username": "alice",
                "discriminator": "0"
