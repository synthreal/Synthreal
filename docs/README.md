# Synthreal Documentation

Welcome to the Synthreal documentation. Synthreal is the open-source Agent Operating System -- 14 Rust crates, 40 channels, 60 skills, 20 LLM providers, 76 API endpoints, and 16 security systems in a single binary.
...
| [Skills](skill-development.md) | 60 bundled skills, custom skill development, SynthHub marketplace |
...
synthreal init && synthreal start
...
| Path | Description |
|------|-------------|
| `~/.synthreal/config.toml` | Main configuration file |
| `~/.synthreal/data/synthreal.db` | SQLite database |
| `~/.synthreal/skills/` | Installed skills |
| `~/.synthreal/daemon.json` | Daemon PID and port info |
